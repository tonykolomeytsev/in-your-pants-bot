    ...
    override fun getFromRemote(k: Unit): Phrases {
        return Phrases(
            actualForOneWord = mapOf(
                ...
                listOf("привет", "здарова", "здравствуйте", "прив", "здороу", "хай") to listOf("иди нахер", "не пиши сюда", "зачем"),
                ...
                listOf("хуй", "хуя") to listOf("его нет у тебя в штанах", "думаешь ты смешной")
            ).convert(),
